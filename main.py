...
app = FastAPI()
COLAB_WORKER_URL = os.getenv("COLAB_WORKER_URL", "https://366c-34-142-166-3.ngrok-free.app")
API_KEY = os.getenv("API_KEY", "7375db0fbea64486d088812d460e083daa07307b67ee61758e2b4cdadbc905c1")
UPLOAD_DIR = "uploads"
CHART_DIR = "charts"
...
async def upload_video(
    ...
    try:
        ...
        background_tasks.add_task(notify_colab_worker, job_id)
